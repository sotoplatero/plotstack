    ...
    local: {
      get: async () => ({
        ...
        "plotstack.snapshot": {
          ...
          metrics: { subscribers: 2840, paidSubscribers: 184, openRate: 47.3, clickRate: 6.8, monthlyRevenue: 1425, followers: 3900, appSubscribers: 720 },
        ...
        "plotstack.analytics": {
          ...
          retention: { free: { cohorts: [], rates: [{ month: 1, rate: 0.82, comparison: 0.04 }, { month: 3, rate: 0.71, comparison: 0.02 }] }, paid: { cohorts: [], rates: [] } },
          content: { counts: {} },
          coverage: [],
        },
      }),
