...
4. **Notas** — seis cifras grandes en la cabecera (notas, impresiones,
   interacciones, visitas al perfil, clics a enlaces, altas atribuidas), sin
   tasas ni desgloses en letra pequeña. Dos cards con gráfico de pastel para
   "Dónde se ven tus notas" y "Quién las ve"; el centro del segundo lleva el
   porcentaje de impresiones fuera de tu audiencia. Mapa de calor día × hora
   (7 × 24), listado paginado de 25 en 25,
